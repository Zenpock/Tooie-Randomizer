...
void LogicTracker::OnSelchangeLogicFile()
{
	...
	logicGroups.clear();
	LogicGroup::LoadLogicGroupsFromFile(logicGroups, (LogicFilePaths[logicSelector.GetCurSel()]).Path.c_str());
...
void  LogicTracker::UpdateLists()
{
	...
	std::set<int> lookedAt, next, viable;
	...
	startingState.AddCollectable(Collect_Note, 5000);
	startingState.AddCollectable(Collect_Jiggy, 5000);
	startingState.AddCollectable(Collect_Glowbo, 5000);
	startingState.AddCollectable(Collect_Black_Jinjo, 5000);
	startingState.AddCollectable(Collect_Blue_Jinjo, 5000);
	startingState.AddCollectable(Collect_Red_Jinjo, 5000);
	startingState.AddCollectable(Collect_Purple_Jinjo, 5000);
	startingState.AddCollectable(Collect_White_Jinjo, 5000);
	startingState.AddCollectable(Collect_Orange_Jinjo, 5000);
	startingState.AddCollectable(Collect_Green_Jinjo, 5000);
	startingState.AddCollectable(Collect_Brown_Jinjo, 5000);
	startingState.AddCollectable(Collect_Yellow_Jinjo, 5000);
	startingState.AddCollectable(Collect_Doubloon, 5000);
	startingState.AddCollectable(Collect_Cheato_Page, 5000);
	startingState.AddCollectable(Collect_Mega_Glowbo, 5000);
	startingState.AddCollectable(Collect_Ticket, 5000);
	startingState.AddCollectable(Collect_Honeycomb, 5000);
	startingState.AddCollectable(Collect_Boggy_Fish, 5000);
	startingState.AddCollectable(Collect_Jade_Totem, 5000);
